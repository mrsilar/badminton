...
<table class="am-table am-table-bordered am-table-radius am-table-striped">
    ...
    <tr>
        ...
        <td>
            <a style="color: #52b2ff" href="/h5/member/activity/specail/four/chang_team?team_match_id=<?php echo isset($team_match[$row->id][$va->team_id][$vb->team_id]->id) ? $team_match[$row->id][$va->team_id][$vb->team_id]->id : ''; ?>">
