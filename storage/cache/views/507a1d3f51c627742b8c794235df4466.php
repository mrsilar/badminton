...
<head><meta charset="utf-8">
    ...
    <meta name="apple-mobile-web-app-title" content="嗨加游">
...
<div class="swiper-slide">
	...
	<!--
	<a class="am-btn am-btn-success" style="float:right" href="/h5/member/four/chang_table?activity_id=<?php echo isset($activity_id) ? $activity_id : ''; ?>">人员调整</a>
	-->
