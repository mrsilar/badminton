...
<table class="am-table am-table-bordered am-table-radius am-table-striped">
    ...
    <tr>
        ...
        <td>
            ...
            <a style="color: #52b2ff" href="/h5/member/activity/set/score_sub?team_match_id=<?php echo isset($team_match[$key][$va->team_id][$vb->team_id]->id) ? $team_match[$key][$va->team_id][$vb->team_id]->id : ''; ?>">
            ...
            <?php } else { ?>
            <a style="color: #52b2ff" href="/h5/member/activity/set/score_sub?team_match_id=<?php echo isset($team_match[$key][$vb->team_id][$va->team_id]->id) ? $team_match[$key][$vb->team_id][$va->team_id]->id : ''; ?>">
